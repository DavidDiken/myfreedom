...
@section('title', "Заявка на безкоштовну консультацію")
@section('meta_description', "Заповніть форму та отримайте безкоштовну консультацію")

@section('content')
    <section class="hero">
        <h1 class="h1">Заявка на безкоштовну консультацію</h1>
